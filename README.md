...
* 端口：443
* 默认UUID：2d291ed8-0336-48c0-9d12-4571f028d325
* vmess额外id：0
* 加密：none
* 传输协议：ws
* 伪装类型：none
* 伪装域名：xxx.workers.dev(CF Workers反代地址)
* 路径：/2d291ed8-0336-48c0-9d12-4571f028d325-vless // 默认vless使用(/自定义UUID码-vless)，vmess使用(/自定义UUID码-vmess)
* 底层传输安全：tls
* 跳过证书验证：false
```
</details>
...
* 客户端下载: https://github.com/p4gefau1t/trojan-go/releases
{
    ...
    "remote_port": 443,
    "password": [
        "2d291ed8-0336-48c0-9d12-4571f028d325"
    ],
    "websocket": {
        "enabled": true,
        "path": "/2d291ed8-0336-48c0-9d12-4571f028d325-trojan",
...
* 端口: 443
* 密码：2d291ed8-0336-48c0-9d12-4571f028d325
